...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTable = "CREATE TABLE people_table (ID INTEGER PRIMARY KEY AUTOINCREMENT, firstName TEXT, lastName TEXT, number TEXT, email TEXT)";
    ...
    public boolean addData(String firstName, String lastName, String number, String email) {
